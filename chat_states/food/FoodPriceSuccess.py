...
@RegisterChatState("food_price_success")
class FoodPriceSuccess(ChatState):
    ...
    def on_enter(self, from_: ChatState, args, is_interrupt: bool):
        ...
        self.context.outputer.send(CardBasic(
            ...
            footer=[
                Button("ช่วยจดหน่อยว่ากินไรไป", MessageAction("จด")),
                Button("ไม่อยากบอกว่ากินไรไป", MessageAction("ไม่บอก"))
            ]
        ))
